...
const LoginForm = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen w-full rootina-pattern-bg">
      <Card className="w-full max-w-md mx-4 p-8 rounded-xl shadow-lg bg-white">
